...
if ( window.self != window.top) {
	...
	while (el.parentNode) {
        ...
        el.style.zIndex = "100";
				...
				closeButton.onclick = function() {this.parentNode.parentNode.parentNode.parentNode.removeChild(this.parentNode.parentNode); return false; console.log("closed the ad");};
