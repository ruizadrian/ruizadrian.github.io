function eplanning() {
    ...
    epl.style.setProperty ("height","250px", "important");
...
function updateNativeDiv() {
    ...
    if (parentDiv.tagName == 'DIV') {
        ...
        if( tag_id.indexOf("google_ads_iframe_") >= 0){
            ...
            parentDiv.style.setProperty ("height","250px", "important");
            parentDiv.style.setProperty ("width", "300px", "important");
        }
    }
    ...
    if (gptDiv.tagName == 'DIV') {
        ...
        if( tag_id.indexOf("gpt_unit_") >= 0){
            ...
            gptDiv.style.setProperty ("height","250px", "important");
            gptDiv.style.setProperty ("width", "300px", "important");
        }
    }
    ...
    //         gptDiv2.style.setProperty ("height","250px", "important");
    //         gptDiv2.style.setProperty ("width", "300px", "important");
    //     }
    // }
    ...
    if (gptDiv2.tagName == 'DIV') {
     ...
     if (gptDiv3.tagName == 'DIV') {
        ...
        if( tag_id.indexOf("div-gpt-ad-") >= 0){
            ...
            gptDiv3.style.setProperty ("height","250px", "important");
            gptDiv3.style.setProperty ("width", "300px", "important");
        }
    }
